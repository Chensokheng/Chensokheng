...
export default function UserInfo() {
	...
	return (
		<div className="mt-20 mb-20 bg-gray-200 dark:bg-secondary rounded-md p-5">
			...
			<p className="mt-5 dark:text-gray-300 text-gray-700  tex-sm tracking-wide break-words">
				...
				{listUserInfos.map(({ Icon, text }, index) => {
					return (
						<div className="flex  items-center gap-3" key={index}>
							...
							<h1 className="dark:text-gray-400 text-gray-600">{text}</h1>
						</div>
					);
				})}
			</div>
